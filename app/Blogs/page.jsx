      ...
      <section className="my-20 px-3 sm:px-6 md:px-12 lg:px-28 xl:px-36 text-black">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          <div>
            ...
            <div className="overflow-hidden rounded-xl bg-zinc-300">
              <img
                className="w-full"
                src="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/BLOG_HEADER_Felix_v2_2096x1182_1.width-400.format-webp.webp"
                alt=""
              />
              <div className="p-6">
                <div>
        ...
        <div className="bg-gray-100 text-center rounded-xl py-10 my-10">
          <h1 className="text-xl">
            Get the latest{" "}
            <samp className="text-blue-600">news from Google</samp> in your
            inbox.
          </h1>
        ...
        <div className="flex my-10 rounded-xl p-8 shadow-md hover:shadow-lg hover:shadow-gray-700 transition-all shadow-gray-600 flex-col-reverse lg:flex-row">
          <div className="lg:w-[65%]">
            ...
            <div className="flex items-center gap-6">
              <img
                ...
                width="60px"
                height="60px"
                src="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/SundarPichai_2x.max-122x92.format-webp.webp"
                alt=""
              />
              <div>
          ...
          <img
            className="lg:w-[35%] rounded-lg"
            src="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/hero-1.width-400.format-webp.webp"
            alt=""
          />
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 my-5">
            <div className="border border-gray-400 rounded-xl overflow-hidden">
              ...
              <img
                ...
                src="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Art_Fund_Museum_of_the_Year_2023.width-800.format-webp.webp"
                alt="somting"
              />
            </div>
          </div>
        ...
        <div className="my-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 my-5">
            <div className="flex p-4 rounded-xl border border-slate-400 hover:shadow-lg">
              ...
              <img
                className="w-1/3"
                src="https://storage.googleapis.com/gweb-uniblog-publish-prod/images/1_Header_WearOS_Smartwatch_Blog.max-300x300.format-webp.webp"
                alt=""
              />
            </div>
          </div>
