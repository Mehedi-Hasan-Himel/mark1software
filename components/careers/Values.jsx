...
export default function Values() {
  ...
  return (
    <section
    className="my-20 text-center bg-[url('https://assets.showwcase.com/landing-page/images/careers/our-values-bg-effect.png')]">
    ...
    <div className="my-4 px-3 sm:px-6 md:px-12 lg:px-28 xl:px-36">
      {value.map((data)=>{
        return(
            <div className="py-8 border-b-2 border-gray-800 text-start md:flex">
